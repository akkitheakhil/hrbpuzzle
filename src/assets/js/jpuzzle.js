...
function solveIt() {
   for (var i = 0; i < grids.length; i++) {
      ...
      grids[i].style.backgroundImage = "url(assets/images/piece" + i + ".jpg)";
   }
}
...
function init() {
   ...
   for (i = 0; i < pieces.length; i++) {
      pieces[i].style.backgroundImage = "url(assets/images/piece" + randomIntegers[i] + ".jpg)";
   ...
   document.getElementById("checkFinish").onclick = checkFinish;
}
...
function checkFinish() {
   for (var i = 0; i < grids.length; i++) {
      console.log("grids["+i+"]top>>>>"+grids[i].style.top+"-----------pieces["+i+"]top>>>>"+pieces[i].style.top);
      pieces[i].style.backgroundImage = "";
    if(grids[i].style.backgroundImage!=null || grids[i].style.backgroundImage!=undefin){

      }
      grids[i].style.backgroundImage = "url(images1/piece"+i+".jpg)";
   }
}
